...
foreach ($decoded["polyMap"] as $stagiaire) {
	...
	$nom = "<b>{$stagiaire[1]} {$stagiaire[0]}, &eacute;tudiant {$stagiaire[4]} de {$stagiaire[5]}&egrave; ann&eacute;e</b><br />";
	$nom = $nom . "Promotion {$stagiaire[3]}<br />Mail : {$stagiaire[2]}<br />Entreprise : {$stagiaire[6]}<br /><br />{$texteDates}";
	$stagiaireTraite["properties"]["nom"] = $nom;
...
$fichierSauvegarde = "../files/mappingDetaille.geojson";
